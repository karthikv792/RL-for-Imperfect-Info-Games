...
from agents.NeuralNetworkAgent.neuralnet import NeuralNet
...
class NeuralNetPlayer(Player):
    ...
    def get_move_from_nn(self, board, discarded_cards):
        ...
        for belief_state2 in belief_states2:
            ...
            valid_moves = simulator2.players[0].get_legal_moves(simulator2.env.board)
...
class Simulator():
    ...
    def get_state(self, player, opponent):
        ...
        Get state of player
        """
        valid_moves = player.get_legal_moves(self.env.board)
        ...
        opponent_valid_moves = opponent.get_legal_moves(self.env.board)
