...
class Player():
    ...
    def put_without_j2(self, board,  c_row, c_col):
    ...
    def put_with_j2(self, board,  c_row, c_col):
        board.coin_positions[c_row][c_col] = self.team[1]
    ...
    def remove_with_j1(self, board, c_row, c_col):
    ...
    def make_move(self, board):
        ...
        if choice_of_action == 'DoPut':
            ...
            self.put_without_j2(board, c_row, c_col)
...
class Play():
    ...
    def change_corners_for_win_check(self, player):
        self.board.coin_positions[0][0], self.board.coin_positions[0][9], self.board.coin_positions[9][0], \
        self.board.coin_positions[9][9] = [player.team[1]] * 4
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    x, y = event.pos
                    print(x, y)
                    # for i in self.board.board_pics.values(): print(i[1][0],i[1][1]) if y in range(int(i[1][0]),
                    # int(i[1][0] + self.board.board_size * 0.0654)) and x in range(int(i[1][1]), int(i[1][1] +
                    # self.board.board_size // 10)): print("Got it") pygame.draw.circle(self.board.screen, (0,0,255),
                    # i[1][0] + int(self.board.board_size * 0.0654) // 2, i[1][1] + self.board.board_size // 20, 10)
            pygame.display.update()
        return winner
